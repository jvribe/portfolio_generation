...
<img src="https://img.shields.io/badge/JavaScript-ES6%2B-yellow?style=for-the-badge&logo=javascript&logoColor=yellow%22 alt="JavaScript Badge /> 
</div>
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/jvribe/portfolio_generation.git
   ```
...
🔗 https://jvribe.github.io/portfolio_generation
